...
class VIP79 {
    ...
    constructor(page) {
      this.page = page;
      this.uTenDangNhap_DK_Txt = page.locator("//div[@id='register-main']//input[@id='usrname']");
      this.MatKhau_DK_Txt = page.locator("//div[@id='register-main']//input[@id='pwd']");
      this.DangKy_DK_Btn = page.locator("//div[@id='register-main']//button[@type='submit']");
