...
class DA88 {
    constructor(page) {
      ...
      this.DangKy_DK_Btn = page.locator("//*[@id='registerForm']/div[@class='btn-form']");
      this.Header_user = page.locator("//*[@id='header']//div[@class='header-user']");
    }
    ...
    async verifyDangKyThanhCongDA88(domain){
        try{
            await this.delay();
